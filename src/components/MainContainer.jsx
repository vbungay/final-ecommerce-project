    ...
    <div className='w-full h-auto flex flex-col items-center justify-center'>
      ...
      <section className='w-full my-6'>
        <div className='w-full flex items-center justify-between'>
          <p className='text-2xl tracking-wide font-semibold relative text-headingColor before:absolute 
                        before:rounded-lg before:content before:w-20 before:h-1 before:-bottom-2 before:left-0 
                        before:bg-green-400 transition-all ease-in-out duration-100'
          >
            Best Sellers
          </p>
          <div className='hidden md:flex gap-3 items-center'>
            <motion.div
              whileTap={{ scale: 0.75 }}
              onClick={scrollLeft}
              className='w-8 h-8 rounded-lg bg-green-400 hover:bg-green-700 cursor-pointer transition-all 
